...
# hydrobasin on MG
hydrobasin_mg <- st_read(file.path(dir_data, "hydroshed","hydrobasins_level9","hydrobasin_mg.shp"))

# hydrographic network on MG
hydronetwork <- st_read(file.path(dir_data, "water_surface", "second.shp"))
